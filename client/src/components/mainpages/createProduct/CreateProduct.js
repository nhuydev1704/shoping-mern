    ...
    return (
        <div className="create_product">
            <div className="upload">
                ...
                {
                    loading ?
                        <div id="file_img"><Loading></Loading></div>
                        :
            ...
            <form onSubmit={onSubmit}>
                <div className="row">
                    ...
                    <input type="text" name="product_id" id="product_id" disabled={onEdit} required value={product.product_id} onChange={handleChangeInput} />
                </div>
